...
public class PostBusinessServiceImpl implements PostBusinessService {
    ...
    @Autowired
    public PostBusinessServiceImpl(TagsService tagsService, PostService postService, UserService userService, ImageService imageService, StorageService storageService) {
